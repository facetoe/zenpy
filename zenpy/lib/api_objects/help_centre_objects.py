...
class Article(BaseObject):
    ...
    def __init__(self,
        ...
        self.content_tag_ids = content_tag_ids
    ...
    def content_tags(self):
        ...
        if self.api and self.content_tag_ids:
            return self.api._get_content_tags(self.content_tag_ids)

    @content_tags.setter
    def content_tags(self, content_tags):
        if content_tags:
            self.content_tag_ids = [o.id for o in content_tags]
