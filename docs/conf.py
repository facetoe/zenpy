# -*- coding: utf-8 -*-
#
# Zenpy documentation build configuration file, created by
# sphinx-quickstart on Sun Sep 13 17:05:01 2015.
#
...
sys.path.insert(0, os.path.abspath('../'))
sys.path.insert(0, os.path.abspath('../zenpy/lib'))
